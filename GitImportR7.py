...
def instalador():
    ...
    if aux2 == 1:
        ...
        if aux3 == 's':
            ...
            instalador()
    subprocess.call("sudo svn list https://github.com/MinCiencia/Datos-COVID19/branches/master/output/producto4 > data.txt", shell=True)
    ...
    subprocess.call("sudo svn export --force https://github.com/MinCiencia/Datos-COVID19/branches/master/output/producto4/"+file, shell=True)
    return file
